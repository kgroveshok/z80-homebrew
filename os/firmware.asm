...
;if DEBUG_LEVEL0
;	include "debug_level0.asm"
;endif
;if DEBUG_LEVEL1
;	include "debug_level1.asm"
;endif
;if DEBUG_LEVEL2
...
display_fb0: equ  key_shift-display_fb_len -1 ; -display_fb_len-1          ; cli input     TODO why is that doubling up?
; working frame buffers
display_fb1: equ  display_fb0-display_fb_len -1 ; -display_fb_len-1          ; default running program
...
os_var_array: equ chk_data_ovr - (32 * 2)      ;   32 word array for use using the SCRATCH word
