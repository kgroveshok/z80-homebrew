...
#define SPI_WIFI_USE_WEBSERVER  0x0d

// Buffers
#define SPI_POOL 0x23

// Buffers sub commands
#define SPI_POOL_PUT 0x01             // append or over write next pos
#define SPI_POOL_GET 0x02             // get next char from pool until eof
#define SPI_POOL_SELECT 0x03         // done
#define SPI_POOL_CLR 0x04
#define SPI_POOL_UART_OUT 0x05         //done     // dump pool to uart
#define SPI_POOL_UART_IN 0x06      // load pool from uart
#define SPI_POOL_POS  0x07     // set pos for get
#define SPI_POOL_REWIND 0x08    // fast set pos to start
#define SPI_POOL_APPEND 0x09    // fast set pos to end of file for next put
#define SPI_POOL_IS_EOF 0x0a    // are we done reading?
